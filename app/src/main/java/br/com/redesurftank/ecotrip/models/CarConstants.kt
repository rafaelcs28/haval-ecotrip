...
enum class CarConstants(val value: String) {
    ...
    // ATENÇÃO: usa "ev.setting" (PONTO), diferente das outras chaves EV que usam
    // "ev_setting" (underscore). Trocar pro underscore quebra o toggle — a chave
    // com ponto é a real do IVehicle (verificado na prática 2026-06-13).
